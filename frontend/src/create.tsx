...
const CreateAccount = () => {
    ...
    const handleSubmit = () =>{
        ...
        axios.post(`${link}/create`, {username: username, password: password})
    ...
    return (
        <div className="w-screen h-screen flex items-center justify-center">
            <div className="w-[300px] h-[300px] flex flex-col items-center justify-center border-4 rounded-3xl">
                ...
                <button className="bg-blue-200 my-4 text-gray-500" name="submit" onClick={handleSubmit}>Sign Up</button>
            </div>
        </div>
    )
}
